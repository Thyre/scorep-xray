...
static void
scorep_get_ibm_compiler_version( const std::string& compiler, int& major, int& minor )
{
    FILE*       console;
...
inline void
addXrayFlags( std::string& flags, SCOREP_Instrumenter_CmdLine& cmdLine, XRayPlugin::Config xrayConfig,
